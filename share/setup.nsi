...
!define URL http://www.stakerush.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/stakerush.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\stakerush-qt.exe
...
OutFile stakerush-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/stakerush-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/stakerushd.exe
    ...
    #Delete /REBOOTOK $INSTDIR\stakerush.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\stakerush-qt.exe
